...
if __name__ == '__main__':
    # filepath = '../knowledge_graph/output/YAGO3/taxonomy-types-facts-id-pair'
    ...
    # pagerank power law
    filepath = '../snap_based/output/taxonomy-types-facts-id-pair/taxonomy-types-facts-id-pair-pagerank'
    label = 'taxonomy-types-facts-id-pair'
