...
if __name__ == '__main__':
    # filepath = '../knowledge_graph/output/DBpedia/ontology_instancetype_mappingbased_id_pair'
    ...
    # pagerank power law
    filepath = '../snap_based/output/ontology_instancetype_mappingbased_id_pair/ontology_instancetype_mappingbased_id_pair-pagerank'
    label = 'ontology_instancetype_mappingbased_id_pair'
